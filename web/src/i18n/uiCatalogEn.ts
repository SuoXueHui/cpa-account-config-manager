export const enUI = {
  ...
  "ui.credit_usage_history_boundary_description": "Only successful requests observed after this experiment is enabled are billed. Existing token totals, quota windows, inspections, and overdraft usage are unchanged.",
  ...
  "ui.adaptive_weekly_overdraft": "Codex adaptive maximum overdraft",
  "ui.adaptive_weekly_overdraft_description": "Stores a verified strategy per account, activates only after the seven-day quota reaches 99%, and escalates through S1, S2, and S4 within fixed bounds.",
  "ui.adaptive_weekly_overdraft_request_behavior": "Only Codex requests with a schema v2 selected account are considered. Requests below 99%, with stale usage, or without account attribution pass through unchanged.",
  "ui.adaptive_weekly_overdraft_automation_behavior": "Only definitive weekly-quota failures escalate from S1 to S2 and S4. Transient rate limits do not escalate, and 401/402 stops probing immediately.",
  "ui.adaptive_weekly_overdraft_availability_notice": "No fixed overdraft amount is guaranteed; results depend on upstream account and workspace state.",
  "ui.adaptive_weekly_overdraft_host_schema_required": "CPA request lifecycle schema v2 is required; this host does not support this mode.",
  "ui.adaptive_weekly_overdraft_configuration_warning": "Both overdraft modes were enabled at startup; the author mode was preserved and adaptive mode was disabled.",
	"ui.adaptive_token_first_controls": "Token-first adaptive controls",
	"ui.adaptive_token_drain": "Session drain after 99%",
	"ui.adaptive_token_drain_description": "Pins canary sessions to proven post-threshold credentials for 30 minutes, while limiting the number of sessions bound to each credential.",
	"ui.adaptive_token_drain_percent": "Scheduler canary percentage",
	"ui.adaptive_token_drain_max_sessions": "Maximum sessions per credential",
	"ui.adaptive_tool_output": "Tool-output tail compatibility",
	"ui.adaptive_tool_output_description": "Allows a separate canary to inject after function_call_output and custom_tool_call_output tails instead of only user-message tails.",
	"ui.adaptive_tool_output_percent": "Tool-output canary percentage",
	"ui.sessions": "sessions",
  "ui.test_original_overdraft_mode": "Test author overdraft mode",
  "ui.test_adaptive_overdraft_mode": "Test adaptive maximum overdraft",
  "ui.adaptive_model_test_description": "The adaptive test runs bounded S1, S2, and S4 probes and escalates only after a definitive weekly-quota failure. It never loads the author mode at the same time.",
  "ui.adaptive_overdraft_strategy": "Adaptive {strategy}",
  "ui.adaptive_overdraft_armed": "Adaptive pending verification",
  "ui.adaptive_overdraft_exhausted": "Adaptive strategies exhausted",
  "ui.adaptive_overdraft_success_count": "Window successes: {count}",
  "ui.adaptive_overdraft_token_count": "{count} tok",
  "ui.adaptive_overdraft_injection_stats": "Injected {strategy}: {attempts} attempts / {successes} success / {failures} failures",
  "ui.adaptive_overdraft_workspace_stopped": "Workspace stopped",
  "ui.adaptive_overdraft_authentication_stopped": "Authentication stopped",
  "ui.adaptive_overdraft_stopped": "Adaptive overdraft stopped",
  "ui.adaptive_overdraft_no_further_probes": " · no further probes",
