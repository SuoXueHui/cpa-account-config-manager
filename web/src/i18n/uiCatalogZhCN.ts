...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.credit_usage_history_boundary_description": "只计费开启后新采集的成功请求；现有 Token 汇总、额度窗口、巡检和透支用量均保持不变。",
  ...
  "ui.adaptive_weekly_overdraft": "Codex 自适应最大透支",
  "ui.adaptive_weekly_overdraft_description": "按账号记录已验证策略，仅在七日额度达到 99% 后启用，并按 S1、S2、S4 有界升级。",
  "ui.adaptive_weekly_overdraft_request_behavior": "仅处理 schema v2 已选中账号的 Codex 请求；低于 99%、用量过期或无法归属账号时原样放行。",
  "ui.adaptive_weekly_overdraft_automation_behavior": "明确的周额度失败才从 S1 升级到 S2、S4；瞬时限流不升级，401/402 立即停止探测。",
  "ui.adaptive_weekly_overdraft_availability_notice": "不保证固定透支量；策略受上游账号和工作区状态限制。",
  "ui.adaptive_weekly_overdraft_host_schema_required": "需要 CPA 请求生命周期 schema v2；当前主机不支持此模式。",
  "ui.adaptive_weekly_overdraft_configuration_warning": "启动配置同时开启了两种透支模式，已保留作者模式并关闭自适应模式。",
	"ui.adaptive_token_first_controls": "Token-first 自适应控制",
	"ui.adaptive_token_drain": "99% 后会话集中调度",
	"ui.adaptive_token_drain_description": "将灰度会话在 30 分钟内绑定到已验证的破限凭证，同时限制每个凭证承载的会话数量。",
	"ui.adaptive_token_drain_percent": "调度灰度比例",
	"ui.adaptive_token_drain_max_sessions": "每凭证最大会话数",
	"ui.adaptive_tool_output": "工具输出尾部兼容",
	"ui.adaptive_tool_output_description": "使用独立灰度允许 function_call_output 与 custom_tool_call_output 结尾请求参与注入，不再仅限用户消息结尾。",
	"ui.adaptive_tool_output_percent": "工具输出灰度比例",
	"ui.sessions": "会话",
  "ui.test_original_overdraft_mode": "测试作者透支模式",
  "ui.test_adaptive_overdraft_mode": "测试自适应最大透支",
  "ui.adaptive_model_test_description": "自适应测试会按 S1、S2、S4 执行有界探测，并在明确的周额度失败后升级；不会同时加载作者模式。",
  "ui.adaptive_overdraft_strategy": "Adaptive {strategy}",
  "ui.adaptive_overdraft_armed": "Adaptive 待验证",
  "ui.adaptive_overdraft_exhausted": "Adaptive 策略已耗尽",
  "ui.adaptive_overdraft_success_count": "观测窗口成功 {count}",
  "ui.adaptive_overdraft_token_count": "{count} tok",
  "ui.adaptive_overdraft_injection_stats": "注入 {strategy}：{attempts} 次 / 成功 {successes} / 失败 {failures}",
  "ui.adaptive_overdraft_workspace_stopped": "工作区已停止",
  "ui.adaptive_overdraft_authentication_stopped": "鉴权已停止",
  "ui.adaptive_overdraft_stopped": "自适应透支已停止",
  "ui.adaptive_overdraft_no_further_probes": " · 不再探测",
